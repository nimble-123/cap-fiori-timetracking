...
annotate service.Region with @(Common.Label: '{i18n>entity.Region}');
...
annotate service with @(
  ...
  title               : 'Time Tracking - Admin Service',
  Core.LongDescription: 'Service for managing customization of time tracking.'
);
